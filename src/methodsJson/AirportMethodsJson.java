...
public class AirportMethodsJson implements IAirportMethods {

	private ArrayList<Airport> airportList;
	private static GenericProviderJson<Airport> genericProvider;

	public AirportMethodsJson() {
		genericProvider = new GenericProviderJson<Airport>(new File("airport"));
	}
